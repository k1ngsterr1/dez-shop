    ...
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-primary/5 to-primary/10 shadow-md">
      <div className="container w-full relative z-10 mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid items-start gap-8 md:grid-cols-2">
          ...
          <div className="mt-19">
            <Card className="border border-border/50 bg-card/90 backdrop-blur-sm shadow-lg">
                ...
                <div className="space-y-8 py-4">
                  ...
                  <div className="pt-4 border-t border-border">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <p className="text-muted-foreground">Расход на 1 м²</p>
            ...
            <div className="relative rounded-xl overflow-hidden mt-6 aspect-video">
              <Image
                src={pharmacy}
